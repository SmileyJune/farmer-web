...
<div id="body-wrapper">
  ...
  <div id="sidebar">
    <div id="sidebar-wrapper">
      ...
      <div id="profile-links"> Hello, <a href="#" title="Edit your profile">admin</a>, you have <a href="#messages" rel="modal" title="3 Messages">3 Messages</a><br />
        <br />
        <a href="#" title="View the Site">View the Site</a> | <a href="#" title="Sign Out">Sign Out</a> </div>
       <ul id="main-nav">
        <li> 
            <a href="#/" class="nav-top-item no-submenu current">后台首页</a> 
        </li>
        <li> 
            <a href="#" class="nav-top-item ">文章管理</a>
        </li>
        <li> 
            <a href="#" class="nav-top-item">文章分类管理</a>
        </li>
        <li> 
          <a href="#" class="nav-top-item">导航管理</a>
        </li>
        <li> 
          <a href="#" class="nav-top-item">订单管理</a>
        </li>
        <li> 
          <a href="#" class="nav-top-item">产品管理</a>
        </li>
        <li> 
          <a href="#" class="nav-top-item">配置管理</a>
        </li>
        <li> 
          <a href="#" class="nav-top-item">管理员</a>
        </li>
  ...
  <div id="main-content">
    ...
    <ul class="shortcut-buttons-set">
      <li><a class="shortcut-button" href="#"><span> <img src="../static/admin/images/icons/pencil_48.png" alt="icon" /><br />
        Write an Article </span></a></li>
      <li><a class="shortcut-button" href="#"><span> <img src="../static/admin/images/icons/paper_content_pencil_48.png" alt="icon" /><br />
    ...
    <div class="content-box">
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
          ...
          <div class="notification attention png_bg"> <a href="#" class="close"><img src="../static/admin/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <!-- Icons -->
                  <a href="#" title="Edit"><img src="../static/admin/images/icons/pencil.png" alt="Edit" /></a> <a href="#" title="Delete"><img src="../static/admin/images/icons/cross.png" alt="Delete" /></a> <a href="#" title="Edit Meta"><img src="../static/admin/images/icons/hammer_screwdriver.png" alt="Edit Meta" /></a> </td>
              </tr>
              <tr>
                <td>
                  <input type="checkbox" />
    ...
    <div id="footer"> <small>
     ...
     <div id="footer"> <small>
      <!-- Remove this notice or replace it with whatever you want -->
      &#169; Copyright 2010 Your Company | Powered by <a href="#">农夫乐园</a></div>
    <!-- End #footer -->
  </div>
  <!-- End #main-content -->
</div>
